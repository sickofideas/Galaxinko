...
const JOKES = {
  CZ: [
    ...
    "Tohle je absolutní a nefalšovaná katastrofa.",
    "Jsem Arnold J. Rimmer, BDP, DDP., technik druhé třídy.",
    "Listere, tvůj mozek je tak malý, že by se schoval za molekulu.",
    "A co takhle směrnice Vesmírného sboru číslo 34124?",
    "Tato loď je nyní pod mým velením!",
    "Jsem naprogramován k tomu, abych byl servilní. Ale tohle je moc.",
    "Co to tu smrdí? Ach, to jsi ty, Listere.",
    "Dave, ty máš IQ menší než automat na kondomy.",
    "Změna plánu. Budeme utíkat a křičet.",
    "Nepanikařte, pane. Už jsem to udělal za vás.",
    "Tvoje ponožky by mohly sloužit jako biologická zbraň.",
    "Tohle je přesně ta chvíle, kdy by se hodila úniková kapsle.",
    "Kdybych měl pusu, tak bych se teď pozvracel.",
    "Tak tohle je konec. Bylo mi ctí s vámi... přežívat.",
    "Až se tohle pokazí, a ono se to pokazí, neříkejte, že jsem vás nevaroval.",
    "Listere, prosím tě, nesahej na ta tlačítka.",
    "Tohle je tak stupidní nápad, že by to mohl vymyslet jedině Rimmer.",
    "Kocoure, co to máš na sobě? Vypadáš jako zmutovaný papoušek.",
    "Já nepotřebuju štěstí. Já potřebuju čistý trenýrky.",
    "Krytone, ty tvoje logické dedukce mě jednou zabijou.",
    "Proč vždycky narazíme na ty nejhorší mimozemšťany v celém vesmíru?",
    "To není moje chyba! To je chyba toho druhýho Rimmera!",
    "Tohle je ta největší chyba v historii lidstva.",
    "Jsem hologram, nemůžu umřít dvakrát. Nebo jo?",
    "Kdo by chtěl toastík? Je to teplé, křupavé...",
    "Toustovač je nejzbytečnější vynález na lodi.",
    "Jak můžeš jíst kari k snídani?",
    "Listere, ty jsi evoluční krok zpátky.",
    "Vesmír je strašně velkej a strašně nudnej.",
    "Kdo řídí tuhle loď? Holly? Tak to jsme mrtví.",
    "Tohle nevypadá jako bezpečná zóna.",
    "Mám plán! Všichni se schováme pod postel.",
    "Já se nebojím. Jen mi selhávají obvody z té hrůzy.",
    "Kdyby hloupost nadnášela, tak tady Rimmer lítá jako holubička.",
    "Takže my se teď jako budeme tvářit, že se nic neděje?",
    "Mám pocit, že na nás něco útočí. Nebo jsem to jen já?",
    "Dave, ty máš zlozvyky, o kterých se nepíše ani v lékařských knihách.",
    "Kdybych věděl, že se tohle stane, zůstal bych ve stázi.",
    "Jsem kočka. Mým jediným úkolem je vypadat dobře.",
    "Nemám rád, když se věci kazí. A ony se kazí furt.",
    "Proč mě nikdy neposloucháte? Vždyť já mám vždycky pravdu!",
    "Tak tohle je oficiálně nejhorší den mého života.",
    "Krytone, sundej ze mě ten svůj zkoumavý pohled.",
    "Listere, ty jsi naprosto postrádající smysl pro hygienu.",
    "Záložní plán? Zalezeme do skříně a budeme plakat.",
    "Tenhle vesmír mě nepřestává fascinovat svou snahou nás zabít.",
    "Tohle je vzpoura, pane!",
    "Listere, jsi zrůda.",
    "Krytone, dostals mě do pěkné kaše.",
    "Nouzový protokol 194!",
    "Krytone, připrav klystýr s tabascem!",
    "Dej mi klíč, ty smegheade!",
    "Jsem zapsán v lodním deníku jako 'hlavní pako'.",
